...
abstract class nc_Ezsqlcore extends nc_System {
    ...
    abstract public function connect($dbuser='', $dbpassword='', $dbhost='localhost');
    ...
    abstract public function select($dbname='');
    ...
    abstract public function query($query, $output=OBJECT);
