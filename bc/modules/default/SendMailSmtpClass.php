...
class SendMailSmtpClass {
    ...
    */   
    ...
    public function __construct($smtp_username, $smtp_password, $smtp_host = "ssl://smtp.yandex.ru", $smtp_port = 465, $smtp_charset = "UTF-8") {
    ...
    */
    function send($mailTo, $subject, $message, $smtp_from) {		
        ...
        try {
			...
			$socket = stream_socket_client($this->smtp_host.':'.$this->smtp_port, $errorNumber, $errorDescription, 30, STREAM_CLIENT_CONNECT, $streamContext);
