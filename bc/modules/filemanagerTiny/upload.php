...
if ( ! empty($_FILES) || isset($_POST['url']))
{
	...
	if($mime_type == "application/vnd.ms-office" || $info['extension'] == "svg" || $info['extension'] == "rar"){
	...
	{
		response(trans("Error_extension").AddErrorLocation() . fix_strtolower($extension), 406)->send();
