...
(function() {
  ...
  Chosen = (function(_super) {
    ...
    Chosen.prototype.set_up_html = function() {
      ...
      this.container = $nc(this.container_id);
    ...
    Chosen.prototype.result_deselect = function(pos) {
      ...
      result = $nc(this.container_id + "_o_" + pos);
        ...
        if (!option.disabled && !option.empty) {
          if (option.group) {
            ...
            if (found) {
              ...
              if ($nc(result_id).innerHTML !== text) $nc(result_id).update(text);
              this.result_activate($nc(result_id));
              if (option.group_array_index != null) {
                $nc(this.results_data[option.group_array_index].dom_id).setStyle({
                  display: 'list-item'
                });
              }
            } else {
              if ($nc(result_id) === this.result_highlight) {
                this.result_clear_highlight();
              }
              this.result_deactivate($nc(result_id));
            }
          }
        }
      }
