...
$config['LicenseName'] = 'krzl.ru';
$config['LicenseKey'] = '29080000P006L000000000000E0';
...
*/
$baseUrl = $HTTP_FILES_PATH.'/userfiles/';
...
*/
//$baseDir = resolveUrl($baseUrl);
$baseDir = $FILES_FOLDER.'/userfiles/';
...
$config['ResourceType'][] = Array(
		...
		'maxSize' => 0,
		'allowedExtensions' => '7z,svg,aiff,asf,bmp,csv,doc,docx,fla,flv,gif,jpeg,jpg,mid,mov,mp3,mp4,mpc,mpeg,mpg,ods,odt,pdf,png,ppt,pptx,pxd,psd,cdr,ai,qt,ram,rar,rm,rmi,rmvb,rtf,sdc,sitd,swf,sxc,sxw,tif,tiff,txt,vsd,wma,wmv,xls,xlsx,zip,x_t,step,igs',
