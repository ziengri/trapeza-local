...
(function($) {
	var methods = {
		...
		addMainElements: function() {
			...
			methods.builder.append(methods.builder.main = $('<div class="fb-main"></div>'), methods.builder.btnsmain = $('<div class="fb-btns-main"><div class="fb-btns-left"><div class="fb-btn-zone"></div></div><div class="fb-btns-right"></div></div>'));
